...
public:
	...
	virtual bool Intersects(const DirectX::BoundingBox& target, const Math::Matrix& world, Collider::CollisionResult* pRes) = 0;
...
//
//	bool Intersects(const DirectX::BoundingSphere& target, const Math::Matrix& world);
//
//private:
