...
public:
	...
	std::list<std::weak_ptr<GameObject>>& WorkGameObjects() { return m_wpGameObjects; }
...
public:
	...
	const std::map<std::string, std::shared_ptr<DrawList>>& GetDrawLists() { return m_spDrawLists; }
private:
