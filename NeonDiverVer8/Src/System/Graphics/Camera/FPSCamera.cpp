...
void FPSCamera::Update()
{
	...
	if (!Application::Instance().GetGameProcess()->GetKeyManager()->GetKeyState(VK_RBUTTON,true))return;
...
const Math::Matrix FPSCamera::GetRotationMatrix()
{
	return Math::Matrix::CreateFromYawPitchRoll(
		m_cameraAngle.y * ToRadians,
		m_cameraAngle.x * ToRadians,
		m_cameraAngle.z * ToRadians
	);
}
