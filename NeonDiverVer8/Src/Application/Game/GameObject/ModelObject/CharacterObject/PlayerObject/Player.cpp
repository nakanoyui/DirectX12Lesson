...
void Player::Init()
{
	m_wpCameraManager = Application::Instance().GetGameProcess()->GetGameManager()->GetCameraManager();
	m_wpKeyManager = Application::Instance().GetGameProcess()->GetKeyManager();
...
void Player::UpdateCollision()
{
	...
	for (const auto& wpEnvironment : Application::Instance().GetGameProcess()->GetGameManager()->GetEnvironmentManager()->GetEnvironmentObjects())
	{
		std::list<Collider::CollisionResult> collisionResults;
