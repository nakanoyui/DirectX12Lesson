...
void MeshCreater::CreateLineSphere(float size, float vertexCount, const Math::Color& color, MeshData<LineCircle>& meshData)
{
	std::vector<LineCircle>* vertices = meshData.GetVertices();
	std::vector<unsigned int>* indices = meshData.GetIndices();
