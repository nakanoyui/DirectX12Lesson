...
public:
	...
	void Create(GraphicsDevice* pGraphicsDevice, const std::vector<ModelVertex>& vertices, const std::vector<MeshFace>& faces, const std::vector<MeshSubset>& subsets, bool bSkinMesh);
