...
public:
	...
	//Y軸回転(横方向回転)行列を返す関数
	const Math::Matrix GetRotationYMatrix() { return Math::Matrix::CreateRotationY(m_cameraAngle.y * ToRadians); }
	...
	// マウスの移動量を返す関数
	const Math::Vector2& GetMouseMove() { return m_mouseMove; }
