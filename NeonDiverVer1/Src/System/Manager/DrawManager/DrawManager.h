...
public:
	...
	void AddDrawList(std::shared_ptr<GameObject> spGameObject) { m_wpGameObjects.push_back(spGameObject); }
...
public:
	...
	std::shared_ptr<DrawList> GetDrawList(const std::string_view& drawListName);
