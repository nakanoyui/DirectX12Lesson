...
public:
	...
	const std::shared_ptr<TextureManager>&GetTextureManager() const { return m_spTextureManager; }
	const std::shared_ptr<MeshManager>&GetMeshManager() const { return m_spMeshManager; }
...
private:
	...
	std::shared_ptr<TextureManager>	m_spTextureManager = nullptr;
	std::shared_ptr<MeshManager>	m_spMeshManager = nullptr;
