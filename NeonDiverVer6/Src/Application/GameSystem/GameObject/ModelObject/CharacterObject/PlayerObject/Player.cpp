...
void Player::DrawPlayer()
{
	...
	Application::Instance().GetGameSystem()->GetTextureManeger()->GetTexture("Scifi.png")->Set(m_wpShaderManager.lock()->GetShader("PlayerShader")->GetCBVCount() + 4);
	m_wpShaderManager.lock()->GetShader("PlayerShader")->DrawModel(*m_spModelWork, m_transform.Matrix());
}
...
{
	ImGui::Text("JumpPower : %f", m_animeSpeed);
